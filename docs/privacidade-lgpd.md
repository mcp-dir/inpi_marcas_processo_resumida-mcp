...
INPI: Processo de Registro de Marca (Resumida) segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [inpi_marcas_processo_resumida@mcp.ai](mailto:inpi_marcas_processo_resumida@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
